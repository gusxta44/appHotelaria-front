...
export default function renderLoginPage() { 
    ...
    //Dentro de divRoot terá uma div chamada container e em container estará o formulário //
    const container = document.createElement('div')
    container.className = 'card p-4 shadow-lg'; //Classe do Bootstrap para criar um card //
    container.style.width = '100%'; //Aplicada a largura de 100% na div container //
